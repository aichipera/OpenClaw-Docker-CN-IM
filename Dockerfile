...
# 安装全局 npm 包
RUN npm install -g openclaw@2026.6.9 opencode-ai@latest clawhub playwright playwright-extra puppeteer-extra-plugin-stealth @steipete/bird @qwen-code/qwen-code@latest @tobilu/qmd@1.1.6
