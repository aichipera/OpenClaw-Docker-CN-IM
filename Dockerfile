...
RUN apt-get update && \
    ...
    npm install -g openclaw@2026.3.23-1 opencode-ai@latest playwright playwright-extra puppeteer-extra-plugin-stealth @steipete/bird @qwen-code/qwen-code@latest && \
    # 安装 bun 和 qmd
